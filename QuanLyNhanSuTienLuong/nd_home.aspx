<%@ Page Title="" Language="C#" MasterPageFile="~/SiteNguoiDung.Master" AutoEventWireup="true" CodeBehind="nd_home.aspx.cs" Inherits="QuanLyNhanSuTienLuong.nd_home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        s<!-- Header --><header class="w3-container" style="padding-top:22px">
